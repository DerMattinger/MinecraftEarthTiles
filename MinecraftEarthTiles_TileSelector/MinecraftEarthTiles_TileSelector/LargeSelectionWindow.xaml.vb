...
Public Class LargeSelectionWindow

    Dim lastChecked As String = ""

    Private Sub Window_Loaded(sender As Object, e As RoutedEventArgs)
        For longitude As Integer = -89 To 90 Step 10
            For latitude As Integer = -180 To 179 Step 10
                ...
                TilesMargin.Left = (latitude * 40) + 720
                TilesMargin.Top = (longitude * 40) + 356
