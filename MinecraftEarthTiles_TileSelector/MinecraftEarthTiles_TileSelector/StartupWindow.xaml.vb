    ...
    Private Sub Btn_magick_Export_Click(sender As Object, e As RoutedEventArgs)
        ...
        Else
            Try
                ...
                End While
                For Each Tile In TilesList
                    GdalBatchFile.WriteLine(Chr(34) & MySettings.PathToMagick & Chr(34) & " convert " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\" & Tile & "_terrain.png" & Chr(34) & " -dither None -remap " & Chr(34) & MySettings.PathToScriptsFolder & "\QGIS\terrain\" & MySettings.Terrain & ".png" & Chr(34) & " " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\" & Tile & "_terrain_reduced_colors.png" & Chr(34))
                    If MySettings.Heightmap_Error_Correction = True Then
                        GdalBatchFile.WriteLine(Chr(34) & MySettings.PathToMagick & Chr(34) & " convert " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_exported.png" & Chr(34) & " -transparent black -depth 16 " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_removed_invalid.png" & Chr(34))
                        GdalBatchFile.WriteLine(Chr(34) & MySettings.PathToMagick & Chr(34) & " convert " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_removed_invalid.png" & Chr(34) & " -channel A -morphology EdgeIn Diamond -depth 16 " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_edges.png" & Chr(34))
                        GdalBatchFile.WriteLine(Chr(34) & MySettings.PathToMagick & Chr(34) & " convert " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_edges.png" & Chr(34) & " " & NumberOfResize & " -layers RemoveDups -filter Gaussian -resize " & MySettings.BlocksPerTile & "x" & MySettings.BlocksPerTile & "! -reverse -background None -flatten -alpha off -depth 16 " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_invalid_filled.png" & Chr(34))
                        GdalBatchFile.WriteLine(Chr(34) & MySettings.PathToMagick & Chr(34) & " convert " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_invalid_filled.png" & Chr(34) & " " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_removed_invalid.png" & Chr(34) & " -compose over -composite -depth 16 " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_unsmoothed.png" & Chr(34))
                        GdalBatchFile.WriteLine(Chr(34) & MySettings.PathToMagick & Chr(34) & " convert " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\" & Tile & "_water.png" & Chr(34) & " -threshold 5%% -alpha off -depth 16 " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\" & Tile & "_water_mask.png" & Chr(34))
                        GdalBatchFile.WriteLine(Chr(34) & MySettings.PathToMagick & Chr(34) & " convert " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\" & Tile & "_water_mask.png" & Chr(34) & " -transparent white -depth 16 " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_water_transparent.png" & Chr(34))
                        GdalBatchFile.WriteLine(Chr(34) & MySettings.PathToMagick & Chr(34) & " convert " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_unsmoothed.png" & Chr(34) & " " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_water_transparent.png" & Chr(34) & " -compose over -composite -depth 16 " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_water_blacked.png" & Chr(34))
                        GdalBatchFile.WriteLine(Chr(34) & MySettings.PathToMagick & Chr(34) & " convert " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_water_blacked.png" & Chr(34) & " -transparent black -depth 16 " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_water_removed.png" & Chr(34))
                        GdalBatchFile.WriteLine(Chr(34) & MySettings.PathToMagick & Chr(34) & " convert " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_water_removed.png" & Chr(34) & " -channel A -morphology EdgeIn Diamond -depth 16 " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_water_edges.png" & Chr(34))
                        GdalBatchFile.WriteLine(Chr(34) & MySettings.PathToMagick & Chr(34) & " convert " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_water_edges.png" & Chr(34) & " -morphology Dilate Gaussian " & NumberOfResizeWater & " -layers RemoveDups -filter Gaussian -resize " & MySettings.BlocksPerTile & "x" & MySettings.BlocksPerTile & "! -reverse -background None -flatten -alpha off -depth 16 " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_water_filled.png" & Chr(34))
                        GdalBatchFile.WriteLine(Chr(34) & MySettings.PathToMagick & Chr(34) & " convert " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_water_filled.png" & Chr(34) & " " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_water_removed.png" & Chr(34) & " -compose over -composite -depth 16 " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & ".png" & Chr(34))
                    Else
                        GdalBatchFile.WriteLine(Chr(34) & MySettings.PathToMagick & Chr(34) & " convert " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_exported.png" & Chr(34) & " " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & ".png" & Chr(34))
                    End If
                    GdalBatchFile.WriteLine(Chr(34) & MySettings.PathToMagick & Chr(34) & " convert " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\" & Tile & "_bathymetry.png" & Chr(34) & " -transparent black -depth 16 " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\" & Tile & "_bathymetry_transparent.png" & Chr(34))
                    GdalBatchFile.WriteLine(Chr(34) & MySettings.PathToMagick & Chr(34) & " convert " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\" & Tile & ".png" & Chr(34) & " " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\" & Tile & "_bathymetry_transparent.png" & Chr(34) & " -compose over -composite -depth 16 " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\" & Tile & ".png" & Chr(34))
                    GdalBatchFile.WriteLine(Chr(34) & MySettings.PathToMagick & Chr(34) & " convert " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\" & Tile & "_bathymetry.png" & Chr(34) & " -evaluate divide 256 -depth 16 -alpha off " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_bathymetry.png" & Chr(34))
                    GdalBatchFile.WriteLine(Chr(34) & MySettings.PathToMagick & Chr(34) & " convert " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_bathymetry.png" & Chr(34) & " -transparent black -depth 16 " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_bathymetry_transparent.png" & Chr(34))
                    GdalBatchFile.WriteLine(Chr(34) & MySettings.PathToMagick & Chr(34) & " convert " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & ".png" & Chr(34) & " " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_bathymetry_transparent.png" & Chr(34) & " -compose over -composite -depth 16 " & Chr(34) & MySettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & ".png" & Chr(34))
                Next
                GdalBatchFile.Close()
            Catch ex As Exception
        ...
        Else
            Try
                ...
                For Each Tile In TilesList
                    ...
                    End Select
                    ScriptBatchFile.WriteLine(Chr(34) & MySettings.PathToWorldPainterFolder & Chr(34) & " wpscript.js " & Chr(34) & MySettings.PathToScriptsFolder.Replace("\", "/") & "/" & Chr(34) & " " & ReplacedString & " " & MySettings.BlocksPerTile & " " & MySettings.VerticalScale & " " & MySettings.highways.ToString & " " & MySettings.streets.ToString & " " & MySettings.buildings.ToString & " " & MySettings.borders.ToString & " " & MySettings.farms.ToString & " " & MySettings.meadows.ToString & " " & MySettings.quarrys.ToString & " " & MySettings.streets.ToString & " " & MapVersionShort)
                Next
                ScriptBatchFile.Close()
            Catch ex As Exception
