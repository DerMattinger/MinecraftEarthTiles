...
#Region "Create Batch Files"
    ...
    Private Sub wpScriptExport(Tile As String)
        Try
            ...
            If StartupWindow.MySettings.vanillaPopulation = True Then
