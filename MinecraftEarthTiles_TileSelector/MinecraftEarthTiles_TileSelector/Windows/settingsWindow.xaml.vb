...
#Region "Path Dialogs"
    ...
    Private Sub Btn_PathToMinutor_Click(sender As Object, e As RoutedEventArgs)
        Dim MinutorFileDialog As New OpenFileDialog With {
            .FileName = "minutor.exe",
            .Filter = "Exe Files (.exe)|*.exe|All Files (*.*)|*.*",
            .FilterIndex = 1
        }
        If MinutorFileDialog.ShowDialog() = Forms.DialogResult.OK Then
...
#Region "GUI"
    ...
    Private Sub Settings_To_GUI(Settings As Settings)
        ...
        txb_PathToMinutor.Text = Settings.PathToMinutor
        ...
        chb_minutor.IsChecked = Settings.minutor
        ...
        chb_bop.IsChecked = Settings.mod_BOP

        chb_byg.IsChecked = Settings.mod_BYG

        chb_terralith.IsChecked = Settings.mod_Terralith

        chb_create.IsChecked = Settings.mod_Create
    ...
    Private Function GUI_To_Settings() As Settings
        ...
        If File.Exists(txb_PathToMinutor.Text) Then
            LocalSettings.PathToMinutor = txb_PathToMinutor.Text
        End If
        ...
        LocalSettings.minutor = CBool(chb_minutor.IsChecked)
        ...
        LocalSettings.mod_BOP = CBool(chb_bop.IsChecked)

        LocalSettings.mod_BYG = CBool(chb_byg.IsChecked)

        LocalSettings.mod_Terralith = CBool(chb_terralith.IsChecked)

        LocalSettings.mod_Create = CBool(chb_create.IsChecked)
