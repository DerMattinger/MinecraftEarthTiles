    ...
    Private Sub Window_Loaded(sender As Object, e As RoutedEventArgs)
        For longitude As Integer = -89 To 90 Step CType(StartupWindow.MySettings.TilesPerMap, Int32)
            For latitude As Integer = -180 To 179 Step CType(StartupWindow.MySettings.TilesPerMap, Int32)
                ...
                If StartupWindow.MySelection.FullTileList.Contains(tile) Then
                    gpi = New GeneratedImagePreview(StartupWindow.MySettings.PathToScriptsFolder & "\render\" & tile & ".png", 4 * CType(StartupWindow.MySettings.TilesPerMap, Int32), True)
                    gpi.ToolTip = StartupWindow.MySettings.PathToScriptsFolder & "\render\" & longitudeDirection & longitudeNumber & latitudeDirection & latitudeNumber & ".png"
                    gpi.Name = tile
                Else
                    gpi = New GeneratedImagePreview(StartupWindow.MySettings.PathToScriptsFolder & "\render\" & tile & ".png", 4 * CType(StartupWindow.MySettings.TilesPerMap, Int32), False)
                End If
                gpi.Height = 4 * CType(StartupWindow.MySettings.TilesPerMap, Int32)
                gpi.Width = 4 * CType(StartupWindow.MySettings.TilesPerMap, Int32)
