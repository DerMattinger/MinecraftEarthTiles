...
#Region "Create Batch Files"
    ...
    Public Sub QgisRepairBatchExport(Tile As String)
        Try
            ...
            ScriptBatchFile.WriteLine("del """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\osm\" & Tile & "\urban.osm""")
            ScriptBatchFile.WriteLine("del """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\osm\" & Tile & "\broadleaved.osm""")
            ScriptBatchFile.WriteLine("del """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\osm\" & Tile & "\needleleaved.osm""")
            ScriptBatchFile.WriteLine("del """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\osm\" & Tile & "\mixedforest.osm""")
            ScriptBatchFile.WriteLine("del """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\osm\" & Tile & "\beach.osm""")
            ScriptBatchFile.WriteLine("del """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\osm\" & Tile & "\grass.osm""")
            ScriptBatchFile.WriteLine("del """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\osm\" & Tile & "\farmland.osm""")
            ScriptBatchFile.WriteLine("del """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\osm\" & Tile & "\meadow.osm""")
            ScriptBatchFile.WriteLine("del """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\osm\" & Tile & "\quarry.osm""")
            ScriptBatchFile.WriteLine("del """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\osm\" & Tile & "\water.osm""")
            ScriptBatchFile.WriteLine("del """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\osm\" & Tile & "\glacier.osm""")
            ScriptBatchFile.WriteLine("del """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\osm\" & Tile & "\wetland.osm""")
            ScriptBatchFile.WriteLine("del """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\osm\" & Tile & "\swamp.osm""")
            If ClassWorker.MyTilesSettings.cmdPause Then
                ScriptBatchFile.WriteLine("PAUSE")
            End If
            ScriptBatchFile.WriteLine()
        ...
        If CType(ClassWorker.MyWorldSettings.TilesPerMap, Int16) = 1 Then
            Try
                ...
                Select Case ClassWorker.MyWorldSettings.VerticalScale
                    Case "1000"
                        ScriptBatchFile.WriteLine("""" & ClassWorker.MyTilesSettings.PathToQGIS & "\bin\gdal_translate.exe"" -a_nodata none -outsize " & ClassWorker.MyWorldSettings.BlocksPerTile & " " & ClassWorker.MyWorldSettings.BlocksPerTile & " -Of PNG -ot UInt16 -scale -1152 8848 0 10 """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & TilesOneMoreDigit & "\" & TilesOneMoreDigit & "_AVE_DSM.tif"" """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_exported.png""")
                    Case "500"
                        ScriptBatchFile.WriteLine("""" & ClassWorker.MyTilesSettings.PathToQGIS & "\bin\gdal_translate.exe"" -a_nodata none -outsize " & ClassWorker.MyWorldSettings.BlocksPerTile & " " & ClassWorker.MyWorldSettings.BlocksPerTile & " -Of PNG -ot UInt16 -scale -1152 8848 0 20 """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & TilesOneMoreDigit & "\" & TilesOneMoreDigit & "_AVE_DSM.tif"" """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_exported.png""")
                    Case "300"
                        ScriptBatchFile.WriteLine("""" & ClassWorker.MyTilesSettings.PathToQGIS & "\bin\gdal_translate.exe"" -a_nodata none -outsize " & ClassWorker.MyWorldSettings.BlocksPerTile & " " & ClassWorker.MyWorldSettings.BlocksPerTile & " -Of PNG -ot UInt16 -scale -1152 8848 0 33 """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & TilesOneMoreDigit & "\" & TilesOneMoreDigit & "_AVE_DSM.tif"" """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_exported.png""")
                    Case "200"
                    ...
                    Case "30"
                        ScriptBatchFile.WriteLine("""" & ClassWorker.MyTilesSettings.PathToQGIS & "\bin\gdal_translate.exe"" -a_nodata none -outsize " & ClassWorker.MyWorldSettings.BlocksPerTile & " " & ClassWorker.MyWorldSettings.BlocksPerTile & " -Of PNG -ot UInt16 -scale -1152 8848 0 333 """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & TilesOneMoreDigit & "\" & TilesOneMoreDigit & "_AVE_DSM.tif"" """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_exported.png""")
                    Case "25"
                    ...
                    Case "20"
                        ScriptBatchFile.WriteLine("""" & ClassWorker.MyTilesSettings.PathToQGIS & "\bin\gdal_translate.exe"" -a_nodata none -outsize " & ClassWorker.MyWorldSettings.BlocksPerTile & " " & ClassWorker.MyWorldSettings.BlocksPerTile & " -Of PNG -ot UInt16 -scale -1152 8848 0 500 """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & TilesOneMoreDigit & "\" & TilesOneMoreDigit & "_AVE_DSM.tif"" """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_exported.png""")
                    Case "15"
                        ScriptBatchFile.WriteLine("""" & ClassWorker.MyTilesSettings.PathToQGIS & "\bin\gdal_translate.exe"" -a_nodata none -outsize " & ClassWorker.MyWorldSettings.BlocksPerTile & " " & ClassWorker.MyWorldSettings.BlocksPerTile & " -Of PNG -ot UInt16 -scale -1152 8848 0 667 """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & TilesOneMoreDigit & "\" & TilesOneMoreDigit & "_AVE_DSM.tif"" """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_exported.png""")
                    Case "10"
    ...
    Public Sub ImageMagickBatchExport(Tile As String)
        Try
            ...
            If ClassWorker.MyWorldSettings.Heightmap_Error_Correction = True Then
                ...
                ScriptBatchFile.WriteLine("""" & ClassWorker.MyTilesSettings.PathToMagick & """ convert -negate """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\image_exports\" & Tile & "\" & Tile & "_water.png"" -threshold 20%% -depth 16 """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_water_mask.png""")
                ScriptBatchFile.WriteLine("""" & ClassWorker.MyTilesSettings.PathToMagick & """ convert -negate """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\image_exports\" & Tile & "\" & Tile & "_river.png"" -threshold 20%% -depth 16 """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_river_mask.png""")
                ScriptBatchFile.WriteLine("""" & ClassWorker.MyTilesSettings.PathToMagick & """ composite -gravity center """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_water_mask.png"" """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_river_mask.png""  -depth 16 """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_water_transparent.png""")
                ...
                ScriptBatchFile.WriteLine("""" & ClassWorker.MyTilesSettings.PathToMagick & """ convert """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_water_blacked.png"" -transparent white -depth 16 """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_water_removed.png""")
                ...
                ScriptBatchFile.WriteLine("""" & ClassWorker.MyTilesSettings.PathToMagick & """ convert """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_water_filled.png"" -level 0.002%%,100.002%% """ & ClassWorker.MyTilesSettings.PathToScriptsFolder & "\image_exports\" & Tile & "\heightmap\" & Tile & "_water_filled.png""")
